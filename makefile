...
all: verify_modules create_directories $(BIN_DIRECTORY)/file_generator $(BIN_DIRECTORY)/main
...
$(BIN_DIRECTORY)/file_generator: $(SRC_DIRECTORY)/utils/file_generator.c
